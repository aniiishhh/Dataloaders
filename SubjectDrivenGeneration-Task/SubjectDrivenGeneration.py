...
class SubjectDrivenGeneration_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        prompt_with_token = self.prompts.iloc[idx, 1]

        return (input_image, prompt_with_token, target_image)


if __name__ == "__main__":
    print(SubjectDrivenGeneration_Dataset("Test Data").__getitem__(1))
