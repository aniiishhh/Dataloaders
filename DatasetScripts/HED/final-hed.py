"""
Execute using:
    python final-hed.py --i <Input Folder> --o <Output Folder> --cuda
"""
...
def process_images(input_folder, output_folder, use_cuda=False):
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith((".jpg", ".png", ".jpeg")):
            ...
            hed_result = hed(image_tensor)

            filename = filename.replace(".", "_hed.")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Batch process HED on images")
    parser.add_argument(
