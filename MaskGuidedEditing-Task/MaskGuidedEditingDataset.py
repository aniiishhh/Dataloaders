...
class MaskGuidedEditing_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        mask_path = os.path.join(self.data_dir, "Mask", img_filename)
        ...
        mask = read_image_with_any_extension(mask_path)
        ...
        return (input_image, mask, instruction, target_image)


if __name__ == "__main__":
    print(MaskGuidedEditing_Dataset("Test Data").__getitem__(0))
