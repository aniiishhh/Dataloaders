"""
Execute using:
    python final-openpose.py --i <Input Folder> --o <Output Folder> --cuda
"""
...
def process_images(input_folder, output_folder, use_cuda):
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith((".jpg", ".png", ".jpeg")):
            ...
            processed_image = openpose(image_tensor)

            filename = filename.replace(".", "_openpose.")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Batch process images using Openpose")
    parser.add_argument(
        "--i",
        dest="input_folder",
        required=True,
